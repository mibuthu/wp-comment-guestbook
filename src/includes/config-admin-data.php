...
final class ConfigAdminData {
	...
	public function __construct() {
		$this->config_data = [
			// General.
			'cgb_ignore_comments_open'        => OptionAdminData::new_checkbox(
				[
			...
			'cgb_ignore_comment_registration' => OptionAdminData::new_checkbox(
				[
			...
			'cgb_ignore_comment_moderation'   => OptionAdminData::new_checkbox(
				[
			...
			'cgb_adjust_output'               => OptionAdminData::new_checkbox(
				[
			...
			'cgb_l10n_domain'                 => OptionAdminData::new_text(
				[
			...
			// Comment-form.
			'cgb_form_below_comments'         => OptionAdminData::new_checkbox(
				[
			...
			'cgb_form_above_comments'         => OptionAdminData::new_checkbox(
				[
			...
			'cgb_form_in_page'                => OptionAdminData::new_checkbox(
				[
			...
			'cgb_form_expand_type'            => OptionAdminData::new_radio(
				[
			...
			'cgb_form_expand_link_text'       => OptionAdminData::new_text(
				[
			...
			'cgb_form_require_no_name_mail'   => OptionAdminData::new_checkbox(
				[
			...
			'cgb_form_remove_mail'            => OptionAdminData::new_checkbox(
				[
			...
			'cgb_form_remove_website'         => OptionAdminData::new_checkbox(
				[
			...
			'cgb_form_comment_label'          => OptionAdminData::new_text(
				[
			...
			'cgb_form_title'                  => OptionAdminData::new_text(
				[
			...
			'cgb_form_title_reply_to'         => OptionAdminData::new_text(
				[
			...
			'cgb_form_notes_before'           => OptionAdminData::new_text(
				[
			...
			'cgb_form_notes_after'            => OptionAdminData::new_text(
				[
			...
			'cgb_form_label_submit'           => OptionAdminData::new_text(
				[
			...
			'cgb_form_cancel_reply'           => OptionAdminData::new_text(
				[
			...
			'cgb_form_must_login_message'     => OptionAdminData::new_text(
				[
			...
			'cgb_form_styles'                 => OptionAdminData::new_textarea(
				[
					'rows'        => '7',
			...
			'cgb_form_args'                   => OptionAdminData::new_textarea(
				[
					'rows'        => '10',
			...
			'cgb_clist_threaded'              => OptionAdminData::new_radio(
				[
			...
			'cgb_clist_order'                 => OptionAdminData::new_radio(
				[
			...
			'cgb_clist_child_order_desc'      => OptionAdminData::new_checkbox(
				[
			...
			'cgb_clist_default_page'          => OptionAdminData::new_radio(
				[
			...
			'cgb_clist_pagination'            => OptionAdminData::new_radio(
				[
			...
			'cgb_clist_per_page'              => OptionAdminData::new_number(
				[
			...
			'cgb_clist_num_pagination'        => OptionAdminData::new_checkbox(
				[
			...
			'cgb_clist_show_all'              => OptionAdminData::new_checkbox(
				[
			...
			'cgb_clist_title'                 => OptionAdminData::new_text(
				[
			...
			'cgb_clist_in_page_content'       => OptionAdminData::new_checkbox(
				[
			...
			'cgb_clist_styles'                => OptionAdminData::new_textarea(
				[
					'rows'        => '7',
			...
			'cgb_clist_args'                  => OptionAdminData::new_textarea(
				[
					'rows'        => '7',
			...
			// Comment html code.
			'cgb_comment_adjust'              => OptionAdminData::new_checkbox(
				[
			...
			'cgb_comment_html'                => OptionAdminData::new_textarea(
				[
					'rows'        => '18',
			...
			'cgb_comment_callback'            => OptionAdminData::new_text(
				[
			...
			'cgb_cmessage_enabled'            => OptionAdminData::new_checkbox(
				[
			...
			'cgb_cmessage_text'               => OptionAdminData::new_text(
				[
			...
			'cgb_cmessage_type'               => OptionAdminData::new_radio(
				[
			...
			'cgb_cmessage_duration'           => OptionAdminData::new_text(
				[
			...
			'cgb_cmessage_styles'             => OptionAdminData::new_textarea(
				[
					'rows'        => '7',
			...
			'cgb_page_cmessage_enabled'       => OptionAdminData::new_checkbox(
				[
			...
			'cgb_page_remove_mail'            => OptionAdminData::new_checkbox(
				[
					'label'       => __( 'Remove Email field', 'comment-guestbook' ),
			...
			'cgb_page_remove_website'         => OptionAdminData::new_checkbox(
				[
					'label'       => __( 'Remove Website field', 'comment-guestbook' ),
		...
		$this->sections = [
			'general'       => OptionAdminData::new_section(
				[
			...
			'comment_form'  => OptionAdminData::new_section(
				[
			...
			'comment_list'  => OptionAdminData::new_section(
				[
			...
			'comment_html'  => OptionAdminData::new_section(
				[
			...
			'cmessage'      => OptionAdminData::new_section(
				[
			...
			'page_comments' => OptionAdminData::new_section(
				[
